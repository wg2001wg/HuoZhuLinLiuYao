...
import com.example.huozhulin.data.Yijing
import com.example.huozhulin.data.model.DiZhi
import com.example.huozhulin.data.model.PaiPanResult
import com.example.huozhulin.data.model.kongWang
import com.example.huozhulin.engine.GanZhi
import com.example.huozhulin.engine.GanZhiCalendar
import com.example.huozhulin.engine.LunarCalendar
import com.example.huozhulin.engine.ShenSha
import com.example.huozhulin.ui.components.PlateTable
...
private fun SystemAnalysisPanel(r: PaiPanResult) {
    Column(
        ...
        Text(
            "世爻在${r.original.lines.indexOfFirst { it.shiYing == com.example.huozhulin.data.model.ShiYingType.SHI } + 1}爻，" +
                    "应爻在${r.original.lines.indexOfFirst { it.shiYing == com.example.huozhulin.data.model.ShiYingType.YING } + 1}爻。",
            style = MaterialTheme.typography.bodySmall
        )
